...
layers(4).number = 2; % this layer is fr4 it is a 2nd substrate on top
layers(4).name = 'Addedsubstrate';
layers(4).clearn = 0;
layers(5).number = 1; % this layer is copper it is the top
layers(5).name = 'Component2';
layers(5).clearn = 0;
...
% the substrate another layer up is just in the one corner (pcb-rnd does not support this yet)
substrate_xy(1, 1) = 0; substrate_xy(2, 1) = 0;
substrate_xy(1, 2) = 50; substrate_xy(2, 2) = 0;
substrate_xy(1, 3) = 50; substrate_xy(2, 3) = -50;
substrate_xy(1, 4) = 0; substrate_xy(2, 4) = -50;
CSX = AddPcbrndPoly(CSX, PCBRND, 4, substrate_xy, 1);
...
CSX = AddPcbrndTrace(CSX, PCBRND, 1, points, trace_width, trace_clear);
...
CSX = AddPcbrndTrace(CSX, PCBRND, 5, points, trace_width, trace_clear);
...
CSX = AddPcbrndTrace(CSX, PCBRND, 3, points, trace_width, trace_clear);
